...
namespace DownloadCompass.Database
{
    public class MySQLDB : IDB
    {
        ...
        {
            MySqlConnection objConn = new MySqlConnection(this.GetConnectionString());
            objConn.Open();
            return objConn;
        }
        ...
        public object GetScalar(string p_strComandoSQL)
        {
            ...
            DbCommand objCmd = new MySqlCommand(p_strComandoSQL, (MySqlConnection)objConn);
        ...
        {
            MySqlDataAdapter objAdapter = new MySqlDataAdapter(p_strComandoSQL, this.GetConnectionString());
        ...
        {
            return 7; //this.Execute(MySQLQueryBuilder.BuildInsertQuery(p_strTable, p_arrColumns, p_arrValues));
        }

        public int Replace(string p_strTable, string[] p_arrColumns, object[,] p_arrValues)
        {
            return 7;//this.Execute(MySQLQueryBuilder.BuildReplaceQuery(p_strTable, p_arrColumns, p_arrValues));
        }
